package br.com.projeto.security.jwt;
...
public class JwtTokenProvider {
	...
	private String getRefreshToken(String userName, List<String> roles, Date now) {
		...
		Date validityRefresh = new Date(now.getTime() + (expireLength * 3));
	...
	public boolean validateToken(String token) {
		...
		try {
			...
			throw new InvalidJwtAutenticationException("Token expirado ou inválido!");
		}
	}
}
